...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Tạo một bảng với 4 cột và 4 hàng bên dưới đoạn văn kết thúc ]]><![CDATA[bằng "Our Web distribution solution can give you that capability.".]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67222, 0, MAX_ATTEMPTS, FINAL_VALUE);
