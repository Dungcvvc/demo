...
KeyboardProxy.prototype.enterEvent = function(){
	 ...
	 if(!isUnder(salva_pathSalva.down('1').down('type_window').down(salva_typeWindow).down(salva_typeWindow).down('save')) || !isUnder(salva_pathSalva.down('1').down('movie_apri').down(salva_typeWindow).down('apri').down('apri')) || !isUnder(salva_pathSalva.down('1').down('movie_apri').down('open').down('file').down('1').down('apri').down('apri'))){
...
KeyboardProxy.prototype.shiftF10Event = function(pEvent){
	 console.log('BODY KEY SHIFT-F10');
	 pEvent.SOURCE_EVENT.preventDefault();
	 if(!isUnder(salva_pathSalva.down('1').down('saveAs').down('x'))){
