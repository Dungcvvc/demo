...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Chèn ảnh "Train" trong thư mục "C:\\Docs\\Products", bên dưới đoạn]]><![CDATA[  "Buyer: "Like what?".  ]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67223, 0, MAX_ATTEMPTS, FINAL_VALUE);
