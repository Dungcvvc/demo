...
//				this.get("path").down('1').down('dimensione').setOpacity(0);
				...
				this.get("path").down('1').down('1').down('7').setAction("click","sim.applyBold();$('dxTesto').close();");
				this.get("path").down('1').down('1').down('10').setAction("click","sim.apriCarattere();$('dxTesto').close();");
