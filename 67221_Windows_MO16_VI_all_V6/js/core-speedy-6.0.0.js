...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Áp dụng kiểu in đậm "Bold" cho đoạn văn bản đã chọn.]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67221, 0, MAX_ATTEMPTS, FINAL_VALUE);
