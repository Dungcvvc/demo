...
//				this.get("path").down('1').down('dimensione').setOpacity(0);
		...
		$('dxFolderSave').extend({
			specializedInit : function() {
				...
				this.get("path").down('1').down('dxFolderSave').down('slice_2').setAction("click","");
		...
		$('dxFileSave').extend({
			specializedInit : function() {
				...
				this.get("path").down('1').down('dxFileSave').down('o').setAction("click","$('dxFileSave').close(); salva_openFileFromPopup();");
				this.get("path").down('1').down('dxFileSave').down('slice_2').setAction("click", "");
			}
		});
	} catch (e) {
