...
function initExtendedTextbox(){
	...
	let array = [''];
	//
	//txtList.push({ID:'txt_23423', SOURCE_TEXTBOX: null, ENTER_DISABLED: true, NEW_HEIGHT: '17px', OUTLINE: 'none', MAX_CHAR: 50, FONT_SIZE: '12px', BACKGROUND_COLOR : 'white', OVERFLOW: 'hidden', WHITE_SPACE: 'nowrap', OPACITY : '1', REMOVE_ATTRIBUTE : array, ENTER_CONFIRM: 'KeyboardProxy.prototype.enterEvent();'});
	//
