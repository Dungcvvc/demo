...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Lưu tập tin dưới định dạng PDF trong thư mục "C:\\Docs\\Projects" với tên ]]><![CDATA[mới "Check List".]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67217, 0, MAX_ATTEMPTS, FINAL_VALUE);
