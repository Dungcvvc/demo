...
function gestioneCtrlAlt(shortcut) {
	...
	if (shortcut=='ctrl-s') { //save
			codes.push('0 19 2 0 0');
			return codes;
	}
	if (shortcut=='f12') { // save as
			codes.push('123 0 0 0 0');
			return codes;
	}	
	if (shortcut=='shift-f12') { //save
			codes.push('123 0 0 0 1');
			return codes;
	} 	
	if (shortcut=='ctrl-o') { //open
			codes.push('0 15 2 0 0');
			return codes;
	}	
	if (shortcut=='ctrl-f12') { //open
			codes.push('123 0 2 0 0');
			return codes;
	}	
	if (shortcut=='alt-shift-f2') { // save
			codes.push('113 0 0 8 1');
			return codes;
	}
	if (shortcut=='ctrl-w') { //chiudi
			codes.push('0 23 2 0 0');
			return codes;
	}
	if (shortcut=='alt_freccia_dx') {
	   codes.push('39 0 0 8 0');
	   return codes;
	 }
	 if (shortcut=='alt_freccia_sx') {
	   codes.push('37 0 0 8 0');
	   return codes;
	 }
	 if (shortcut=='alt_freccia_su') {
	   codes.push('38 0 0 8 0');
	   return codes;
	 } 
	 if (shortcut=='backspace') {
	   codes.push('0 8 0 0 0');
	   return codes;
	 }
	 if (shortcut=='ctrl-shift-s') {
	   codes.push('0 19 2 0 1');
	   return codes;
	 }
