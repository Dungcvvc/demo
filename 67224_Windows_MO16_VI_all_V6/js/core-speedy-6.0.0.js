...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Chèn trường trộn có tên là "Street Address" vào (dòng trống) bên ]]><![CDATA[dưới trường "Recipient Name".]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67224, 0, MAX_ATTEMPTS, FINAL_VALUE);
