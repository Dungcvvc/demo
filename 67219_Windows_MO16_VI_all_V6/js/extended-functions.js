...
function initExtendedTextbox(){
	...
	let array = [''];
	//
	//txtList.push({ID:'txt_3906', SOURCE_TEXTBOX: null, ENTER_DISABLED: true, NEW_HEIGHT: '17px', OUTLINE: 'none', MAX_CHAR: 50, FONT_SIZE: '12px', BACKGROUND_COLOR : 'white', OVERFLOW: 'hidden', WHITE_SPACE: 'nowrap', OPACITY : '1', REMOVE_ATTRIBUTE : array, ENTER_CONFIRM: 'KeyboardProxy.prototype.enterEvent();'});
	//
	txtList.push({ID:'txt_3906', DISABLED_WITH_BLINKING:true, CLICK: 'sim.activationTextbox();',SOURCE_TEXTBOX: null, ENTER_DISABLED: true, NEW_HEIGHT: '23px', OUTLINE: 'none', MAX_CHAR: 50, MARGIN: '2px', FONT_SIZE: '21px', BACKGROUND_COLOR : 'white', OVERFLOW: 'hidden', WHITE_SPACE: 'nowrap', OPACITY : '1', REMOVE_ATTRIBUTE : array, ENTER_CONFIRM: 'KeyboardProxy.prototype.enterEvent();'});
