...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Sao chép đoạn văn bản đã được chọn xuống một dòng mới ở cuối tài liệu]]><![CDATA[ "Agenda" đang mở.]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67220, 0, MAX_ATTEMPTS, FINAL_VALUE);
