...
function gestioneCtrlAlt(shortcut) {
    ...
    if (shortcut=='shift-canc')		{ codes.push('127 0 0 0 1'); return codes; }
	if (shortcut=='shift-ins')		{ codes.push('155 0 0 0 1'); return codes; }
    if (shortcut === 'canc') { codes.push('0 127 0 0 0'); return codes; }
	if (shortcut=='ctrl-shift-s') { codes.push('0 19 2 0 1');return codes;}
 	if (shortcut=='ctrl-f6') {  codes.push('117 0 2 0 0');return codes;}
 	if (shortcut=='ctrl-v') {codes.push('0 22 2 0 0');return codes; }
	if (shortcut=='ctrl-ins'){codes.push('155 0 2 0 0'); return codes;}
