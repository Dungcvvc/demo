...
function getXML() {
	...
	<text x="2" id="row_title_0" style="font-family:Arial;font-size:22;" class="titoloDom" y="23"><![CDATA[<![CDATA[Thêm từ "Vitruvio" vào từ điển. ]]>]]></text>
	...
	function RTInitialize() {
		...
		QCO_S = API_DB.createQcoInstance(67226, 0, MAX_ATTEMPTS, FINAL_VALUE);
